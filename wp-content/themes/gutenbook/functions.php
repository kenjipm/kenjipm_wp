...
function gutenbook_scripts() {
	...
	wp_enqueue_style( 'gutenbook-style', get_stylesheet_uri(), array(), '1.0.9', 'all' );

	if ( get_theme_mod( 'gutenbook_style_option' ) === 'theme2' ) {
		wp_enqueue_style( 'gutenbook-theme2', get_template_directory_uri() . '/css/theme2.css', array( 'gutenbook-style' ), '1.0.9', 'all' );
	}
...
/**
 * Add freemius to theme.
 */
if ( ! function_exists( 'gutenbook_fs' ) ) {
	/**
